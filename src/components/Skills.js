        ...
        <div className='flex flex-col items-center justify-between xl:flex-row gap-y-12'>
          ...
          <div className='w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6'>
            <CircularProgressbar
              ...
              text={`${fullBody}%`}
            />
            <div className="font-light text-center uppercase">Full Body Tattoo</div>
          </div>
          {/* progressbar 2 */}
          <div className='w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6'>
            <CircularProgressbar
              ...
              text={`${piercing}%`}
            />
            <div className="font-light text-center uppercase">Safely Piercing</div>
          </div>
          {/* progressbar 3 */}
          <div className='w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6'>
            <CircularProgressbar
              ...
              text={`${fullColor}%`}
            />
            <div className="font-light text-center uppercase">Full Color Tattoo</div>
          </div>
          {/* progressbar 4 */}
          <div className='w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6'>
            <CircularProgressbar
              ...
              text={`${temp}%`}
            />
            <div className="font-light text-center uppercase">Temporary Tatto</div>
          </div>
        </div>
      </div>
    </section>
